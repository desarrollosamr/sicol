...
$where = "WHERE 1=1";
 if($filtropro!=""){
     $where.= " AND gc_bodegas.nombre LIKE '$filtropro%'"; 	
 }
...
$msg = "";
$msg .= '<div class="jtable-title"><div class="jtable-title-text">Bodegas<input type="text" id="criterio"  class="criterio" /><input type="button" id="filtrar" class="go_filtro" value="Filtrar"/><img style="float:right;padding:8px;cursor:copy" src="../Imagenes/add.png" ';
...
$msg .= '<thead>';
$msg .= '<tr>';
$msg .= '<th class="jtable-column-header" style="width:98%;">';
$msg .= '<div class="jtable-column-header-container">';
$msg .= '<span class="jtable-column-header-text">Nombre</span>';
$msg .= '</div></th><th class="jtable-command-column-header" style="width:1%;"></th><th class="jtable-command-column-header" style="width:1%;"></th></tr></thead><tbody>';
...
while ($row = mysqli_fetch_array($result_pag_data)) {
	...
	$msg .= ' onclick="location.href=\'../Plantilla/vistaPrincipal.php?pg=../vistas/paginador1.php&lista=../vistas/frmActualizarrbodegas.php?Id=';
	$msg .= $row['Id'];
	$msg .= '&modulo=recibo';
	$msg .= '\'">';
	...
	$msg .= ' onclick="location.href=\'../controlador/cobodegas.php?boton=eliminar&amp;Id=';
	$msg .= $row['Id'];
	$msg .= '\'">';
