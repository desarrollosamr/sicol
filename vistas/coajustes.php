	...
	Case "Actualizar":
		...
		Case "Agregar":
			...
			if ($resultado)
			{
				...
				$resdespacho= $newdespacho->agregardespachos($fecha,$inicio,$final,$tipo,$clamo,$tiquete,$observacion,$orden,$placas,$carga,$newida,$trans,$conductor,$destino,$cliente);
		        $newdesproducto=new prosalidas;
				$resdesproducto = $newdesproducto->agregarprosalidas( $fecha,$newida, $producto, $cantidadtm, $cantidadsacos, $bodega, $lote , $tipo ,$clamo, $clipro, $moto);				
