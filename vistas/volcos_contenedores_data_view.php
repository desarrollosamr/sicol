...
$msg .= '<select class="criterio" id="bodega"><option value="0">Bodega</option><option value="0" style="background-color:#FFCC66">Resetear</option>';
...
$exportar = '<button class="go_button" style="position:relative;" onclick="location.href=\'../vistas/informes_excel.php?criterio=' . $criterio . '\'" title="Exportar">Exportar</button>';
