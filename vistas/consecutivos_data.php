...
$query_pag_data = "SELECT * from gc_consecutivos order by tabla LIMIT $start, $per_page";
$result_pag_data = mysqli_query($objConexion,$query_pag_data) or die('MySql Error' . mysql_error($objConexion));
$msg = "";
$msg .= '<div class="jtable-title"><div class="jtable-title-text">Consecutivos<img style="float:right;padding:8px;cursor:copy" src="../Imagenes/add.png" ';
$msg .= ' onclick="location.href=\'../Plantilla/vistaPrincipal.php?pg=../vistas/paginador1.php&lista=../vistas/frmActualizarrconsecutivos.php&x=1&modulo=maestros';
$msg .= '\'"></div></div>';
...
$msg .= '<span class="jtable-column-header-text">Tabla</span>';
$msg .= '</div></th><th class="jtable-column-header" style="width:50%;"><div class="jtable-column-header-container"><span class="jtable-column-header-text">Consecutivo</span></div></th><th class="jtable-command-column-header" style="width:1%;"></th></tr></thead><tbody>';
...
while ($row = mysqli_fetch_array($result_pag_data)) {
	...
	$msg .= ' onclick="location.href=\'../Plantilla/vistaPrincipal.php?pg=../vistas/paginador1.php&lista=../vistas/frmActualizarrconsecutivos.php?Id=';
	$msg .= $row['id'];
	$msg .= '&modulo=maestros\'">';
...
/* --------------------------------------------- */
$query_pag_num = "SELECT COUNT(*) AS count FROM gc_consecutivos ";
